...
Alter database dsp_db set gp_default_storage_options="appendonly=true, orientation=row, compresslevel=1";
Alter role dsp_role set gp_default_storage_options='appendonly=true, orientation=column, compresstype=zlib';


\c dsp_db dsp_role

SET gp_default_storage_options='appendonly=true, orientation=column, blocksize=65536, checksum=true, compresslevel=4, compresstype=rle_type'; 
