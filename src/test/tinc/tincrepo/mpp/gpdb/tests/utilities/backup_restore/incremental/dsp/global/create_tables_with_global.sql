...
Alter role dsp_role set gp_default_storage_options='appendonly=true, orientation=column, blocksize=65536, checksum=true, compresslevel=4, compresstype=rle_type'; 
